...
const activity = [
  ...
  },
  {
    ...
    detail: "Temporary account payment reconciled",
    time: "18 min ago",
  },
  {
...
export function DashboardShell({ userEmail, userName }: DashboardShellProps) {
  const displayName = userName || "Finance team";
        ...
        <section className="px-4 py-5 sm:px-6 lg:px-8">
          <header className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                href="/api/health"
                className="inline-flex h-10 items-center gap-2 rounded-lg border border-border bg-surface px-4 text-sm font-medium"
              >
                ...
                <article className="rounded-lg border border-border bg-surface p-5">
                  ...
                  <div className="mt-6 flex flex-col gap-4">
                    {[
                      ...
                      <div
                        key={name}
                        className="rounded-lg bg-surface-strong p-4"
                      >
                        <div className="flex items-center justify-between gap-4">
                          <div>
                ...
                <article className="rounded-lg border border-border bg-surface p-5">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted">
                        Payments from Nomba webhooks land here first.
                      </p>
                    </div>
              ...
              <article className="rounded-lg border border-border bg-surface p-5">
                ...
                <div className="mt-5 flex flex-col gap-3 text-sm">
                  {[
                    ...
                    <div
                      key={step}
                      className="flex gap-3 rounded-lg bg-surface-strong p-3"
                    >
